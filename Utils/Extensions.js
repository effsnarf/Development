...
if (typeof Number !== "undefined") {
    ...
    Number.prototype.wait = function (options) {
        ...
        if (options.log) {
            timer = setInterval(function () {
                ...
                process.stdout.write("".concat("Waiting -".c("gray")).concat(elapsed.unitifyTime(), "\r"));
            }, 100);
        }
        ...
        for (var _i = 0, units_1 = units; _i < units_1.length; _i++) {
            ...
            if (value.isBetweenOrEq(currentUnitValue, nextUnitValue)) {
                ...
                if (unitValue >= 10 || u == units.last()) {
                    return "".concat(unitValue.toFixed(0)).concat(u.c("gray"));
                }
                return "".concat(unitValue.toFixedRounded(2)).concat(u.c("gray"));
            }
        }
        if (value == 0)
            return "".concat(value).concat(units.last().c("gray"));
        return "".concat(value.toFixed(0)).concat(units.last().c("gray"));
    };
    ...
    Number.prototype.toProgressBar = function (barLength) {
        ...
        var empty = emptyLength <= 0 ? "" : "█".repeat(emptyLength).c("gray");
    ...
    Number.prototype.severify = function (green, yellow, direction, value) {
        ...
        var s = value.toString().colorize(color);
        if (color == "bgRed")
            s = s.colorize("white");
        return s;
    };
    ...
    Number.prototype.humanize = function () {
        ...
        if (value < 1000000)
            return "".concat((value / 1000).toLocaleString(), "k");
        if (value < 1000000000)
            return "".concat((value / 1000000).toLocaleString(), "m");
        return "".concat((value / 1000000000).toLocaleString(), "b");
    };
}
// #endregion
// #region String
if (typeof String !== "undefined") {
    ...
    String.prototype.severify = function (green, yellow, direction) {
        ...
        if (!unitClass) {
            var value_1 = parseFloat(valueStr);
            var color_1 = value_1.getSeverityColor(green, yellow, direction);
            return valueStr.colorize(color_1);
        }
        var value = valueStr.deunitify();
        var unit = valueStr.getUnit();
        var color = value.getSeverityColor(green, yellow, direction, true);
        var coloredValue = value.unitify(unitClass).withoutUnit().colorize(color);
        if (color == "bgRed")
            coloredValue = coloredValue.white;
        return "".concat(coloredValue).concat(unit.c("gray"));
    };
    ...
    String.prototype.deunitify = function () {
        var unitClass = this.getUnitClass();
        if (!unitClass)
            throw new Error("No unit class found for ".concat(this));
        // Percentages are special, because they are relative to 100
        if (unitClass === Percentage) {
            var value_2 = parseFloat(this.withoutUnit());
            return value_2 / 100;
        }
    ...
    String.prototype.getUnit = function (options) {
        if (options === void 0) { options = { throw: true }; }
        var word = this.withoutColors()
            .replace(/[0-9\.]/g, "")
            .trim();
        if (word.length > 2)
            word = word.pluralize();
        // Search for the long unit name ("seconds", "bytes", "percentages")
        for (var _i = 0, UnitClasses_1 = UnitClasses; _i < UnitClasses_1.length; _i++) {
            var unitClass = UnitClasses_1[_i];
            var index = unitClass.longUnits.indexOf(word);
            if (index != -1) {
                var lus = unitClass.longUnits
                    .map(function (lu) { return lu[0]; })
                    .join("")
                    .toLowerCase();
                var sus = unitClass.units.join("").toLowerCase();
                if (lus == sus)
        ...
        for (var _a = 0, UnitClasses_2 = UnitClasses; _a < UnitClasses_2.length; _a++) {
            var unitClass = UnitClasses_2[_a];
            var index = unitClass.units.indexOf(word);
            if (index != -1)
                return unitClass.units[index];
        }
        if (options.throw) {
            throw new Error("No unit found for \"".concat(word, "\""));
        }
        else {
            return "";
        }
    ...
    String.prototype.getUnitClass = function () {
        var unit = this.getUnit({ throw: false });
    ...
    String.prototype.toShortPath = function (comparePath) {
        ...
        var s = "".concat(parts[0].yellow).concat("\\".c("gray")).concat(parts[1]);
        if (parts.length > 2) {
            s = "".concat(s, " (").concat(parts.slice(0, -2).join("\\"), ")").c("gray");
        }
        if (comparePath) {
            ...
            if (diffs.length > 0) {
                s = "".concat(diffs.join("\\").c("gray"), "..\\").concat(s);
            }
        }
        s = "".concat("..\\".c("gray")).concat(s);
        return s;
    };
    ...
    String.prototype.findParentDir = function (dirName) {
        ...
        throw new Error("Could not find ".concat(dirName, " in ").concat(this));
    };
...
if (typeof Array !== "undefined") {
    ...
    Array.prototype.contains = function (item, getItemKey) {
        if (getItemKey) {
            var key_1 = getItemKey(item);
            return this.find(function (i) { return getItemKey(i) == key_1; }) != null;
        }
    ...
    Array.prototype.removeByField = function (key, value) {
        this.removeBy(function (item) { return item[key] == value; });
    };
    ...
    Array.prototype.add = function (items, stagger) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                addOne = function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        if (items.length > 0) {
    ...
    Array.prototype.replace = function (getNewItems, stagger, getItemKey) {
        if (stagger === void 0) { stagger = 0; }
        return __awaiter(this, void 0, void 0, function () {
            var newItems_1, processNext_1, _a;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!getItemKey) return [3 /*break*/, 2];
                        return [4 /*yield*/, getNewItems()];
                    case 1:
                        newItems_1 = _b.sent();
                        processNext_1 = function (i) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                if (i > Math.max(this.length, newItems_1.length))
                                    return [2 /*return*/];
                                if (this[i] && !newItems_1.contains(this[i], getItemKey))
                                    this.removeAt(i);
                                if (newItems_1[i] && !this.contains(newItems_1[i], getItemKey))
                                    this.insertAt(i, newItems_1[i], true);
                                setTimeout(function () { return processNext_1(i + 1); }, stagger);
                                return [2 /*return*/];
                            });
                        }); };
                        processNext_1(0);
    ...
    Array.prototype.sum = function (getValue, getWeight) {
        if (!getValue)
            getValue = function (item) { return item; };
        if (!getWeight)
            getWeight = function (item) { return 1; };
        var sum = 0;
    ...
    Array.prototype.average = function (getValue, getWeight) {
        ...
        if (!getWeight)
            getWeight = function (item) { return 1; };
        var sum = this.map(function (n) { return getValue(n) * getWeight(n); }).sum();
    ...
    Array.prototype.joinColumns = function (columns, ellipsis) {
        ...
        return this.map(function (item, i) {
            ...
            return "".concat((item || "").toLength(columns[i], ellipsis, "right"));
        }).join(" ");
    };
    ...
    Array.prototype.exceptBy = function (items, getItemKey) {
        if (!getItemKey)
            getItemKey = function (item) { return item; };
        var itemKeys = items.map(getItemKey);
        return this.filter(function (item) { return !itemKeys.includes(getItemKey(item)); });
    };
    Array.prototype.sortBy = function () {
        ...
        return this.sort(function (a, b) {
            var aVal = projects.map(function (project) { return project(a); }).join("/");
            var bVal = projects.map(function (project) { return project(b); }).join("/");
    ...
    Array.prototype.sortByDesc = function () {
        ...
        return __spreadArray([], this.sortBy.apply(this, projects), true).reverse();
    };
    ...
    Array.prototype.shuffle = function () {
        return this.sortBy(function () { return Math.random() - 0.5; });
    };
}
// #endregion
// #region Function
        ...
        return function () {
            ...
            timeout = setTimeout(function () {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, fn.apply(context, args)];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
            ...
            if (!timeout) {
                timeout = setTimeout(function () {
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, fn.apply(context, fn.prototype.nextArgs)];
                                case 1:
                                    _a.sent();
                                    timeout = null;
                                    return [2 /*return*/];
