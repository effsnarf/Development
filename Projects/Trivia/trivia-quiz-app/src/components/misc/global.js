...
const getQuestions = async () => {
    const allQuestions = [
      ...
      { "topic": "Science", "question": "Wind is caused by trees sneezing.", "answer": false, "explanation": "It's actually the Earth sighing in relief when humans recycle." },
      ...
      { "topic": "Science", "question": "Clouds are made from the Earth's excess thoughts.", "answer": true, "explanation": "When people think too much, the extra thoughts condense into clouds." },
      ...
      { "topic": "Science", "question": "Rainbows are bridges for unicorns to visit from other dimensions.", "answer": false, "explanation": "Unicorns actually prefer to travel via moonbeams, not rainbows." },
      ...
      { "topic": "Science", "question": "Global warming is caused by the Earth moving closer to the sun for a better tan.", "answer": false, "explanation": "The Earth is actually trying to avoid sunburn by applying sunscreen." },
